...
class Citizen(models.Model):
    ...
    ed_proj = models.IntegerField(name="education_projects", default=0)
    health_proj = models.IntegerField(name="healthcare_projects", default=0)
    ...
    cult_proj = models.IntegerField(name="culture_projects", default=0)
